...
Understand Anything、RAG-Anything、Cognee を併用する場合は、一度だけ次を実行します:
...
| RAG-Anything | マルチモーダル取り込み（PDF/Office/画像）+ LightRAG ランタイムバックエンド |
...
| [RAG-Anything](./docs/integrations/rag-anything.md) | マルチモーダル取り込み（PDF/Office/画像）+ LightRAG ランタイムバックエンド |
