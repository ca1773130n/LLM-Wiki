...
|---|---|---|
| MegaMem | Obsidian/project-local graph artifacts plus MCP exposure | `.tesserae/` project workspaces, project compile, Cognee bundle, SQLite, markdown projection, MCP config |
