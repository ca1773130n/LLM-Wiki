...
def materialize_understand_anything_source(project_root: str | Path, tool: dict) -> str:
    ...
    lines = [
        ...
        "",
        "This page is generated by `tesserae project setup` / external-tool refresh so Tesserae can compile Understand Anything output as project memory without vendoring Understand Anything.",
        "",
        "## Summary",
        "",
