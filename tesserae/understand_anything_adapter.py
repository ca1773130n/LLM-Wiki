...
its ``.understand-anything/knowledge-graph.json`` artifact into Tesserae's
controlled ``ResearchGraph`` while preserving external provenance and stable
UA ↔ Tesserae id mappings.
"""
...
class UnderstandAnythingGraphAdapter:
    """Import Understand Anything JSON as Tesserae graph nodes/edges."""
