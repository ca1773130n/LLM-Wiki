"""Managed Understand Anything refresh runner for LLM-Wiki.

This module gives LLM-Wiki a stable shell entrypoint so users do not need to
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Refresh Understand Anything for an LLM-Wiki project.")
