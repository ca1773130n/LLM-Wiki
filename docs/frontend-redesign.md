...
- **Left rail** (desktop ≥ 1024 px): hierarchical tree — Home, Recent activity, Sources, Concepts, Entities, Papers, Repos, Topics, Syntheses, Open questions, Timeline, Graph view, About. Counts come from `manifest.json`.
